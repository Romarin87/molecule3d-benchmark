...
from src.training.gnn import train_egnn
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train an EGNN on Molecule3D and save a checkpoint.")
    ...
    if torch is None:
        raise ImportError("PyTorch is required for EGNN training.")
